...
<form class="w-full lg:min-h-[428px]">
	<img src={previewURL ?? $userProfileData?.photoURL ?? '/user.png'} alt="photoURL" class="mx-auto aspect-square h-56 w-56 rounded-xl border border-white object-cover" />
	...
	<div class="mx-auto flex w-full items-center justify-center">
		<label for="dropzone-file" class="dark:hover:bg-bray-800 flex cursor-pointer items-center justify-center gap-2 rounded-lg bg-gray-50  dark:border-gray-500 dark:bg-transparent">
			<svg class="h-8 w-8 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
				<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2" />
			</svg>
			<p class="mb-2 text-sm text-gray-500 dark:text-gray-400 mt-2">Click to upload</p>
		</label>
