...
<button
	...
	class="aspect-square items-center rounded-lg p-2 text-sm duration-200 hover:bg-secondary-light focus:outline-none focus:ring-4 focus:ring-brand dark:hover:bg-muted-dark dark:focus:ring-brand"
>
