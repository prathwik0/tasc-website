	...
	<div class="mb-8 px-10 md:px-20 lg:px-32">
		...
		<div>
			<div class="font-jbRegular leading-8 md:text-lg">
				...
				<span class="transition duration-300 hover:drop-shadow-[0_0_0.2rem_#d2b863]">
					<a class="leading-8 underline underline-offset-4 drop-shadow-[0_0_0.2rem_#460a07] transition duration-300" href="https://tascnmamit.in" target="_blank">TASC, department of AIML, NMAMIT</a>{' '}
				</span>
				which encourages college students to showcase their creativity and problem-solving skills. It's a platform where young minds can collaborate and innovate to tackle real-world challenges from various industries.
			</div>
