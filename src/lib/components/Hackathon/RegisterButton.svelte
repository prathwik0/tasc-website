...
<button on:click={buttonClick} class="mt-8 flex scale-125 flex-col items-center justify-center">
	<div class="rounded-2xl bg-gray-600 bg-gradient-to-tr from-[#ec4237] via-[#d2b863] to-[#33b6d8] p-0.5 font-jbMedium transition duration-300 hover:drop-shadow-[0_0_0.2rem_#d2b863]">
