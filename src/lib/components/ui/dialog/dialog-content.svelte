...
<Dialog.Portal>
	<Dialog.Overlay />
	<DialogPrimitive.Content {transition} {transitionConfig} class={cn('fixed left-[50%] top-[50%] z-50 grid max-h-[60rem] w-[23rem] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-2xl border-[1px] border-[#d2b863] bg-background py-3 shadow-lg md:w-[60rem] md:p-6 ', className)} {...$$restProps}>
		<slot />
