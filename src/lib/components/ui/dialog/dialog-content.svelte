...
<Dialog.Portal>
	<Dialog.Overlay />
	<DialogPrimitive.Content {transition} {transitionConfig} class={cn('hideScrollbar fixed left-[50%] top-[50%] z-50 grid max-h-[80dvh] max-w-[90dvw] translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-scroll rounded-2xl border-[1px] border-[#d2b863] bg-background py-4 shadow-lg md:w-[60rem] md:p-6 ', className)} {...$$restProps}>
		<slot />
