export const facilitiesData = [
		...
		bullets: [
			{
				...
				points: ['Development of a curriculum tailored to industry standards and requirements', 'Inclusion of real-world case studies and projects to enhance practical skills ', 'Curriculum may span from 40 hrs of elective to 230+ hours of course on AI']
			},
			{
				header: 'Infrastructure Setup',
				points: ['Provision of state-of-the-art hardware and software for the AI Skill Lab', 'Installation of high-performance computing systems and AI development tools']
			},
			{
				header: 'Training Programs',
				points: ['Conducting specialized training sessions for faculty members to ensure effective knowledge transfer', 'Arranging workshops and webinars featuring experts from Dell Technologies']
			},
			{
				header: 'Industry Exposure',
				points: ['Facilitating interactions between students and professionals from Dell Technologies through mentorship programs and guest lectures', 'Providing internship opportunities for students to gain practical industry experience']
			},
			{
				header: 'Certification by Intel: ',
				points: [`Upon successfully completing the course, students will be tasked with a Capstone Project designed to make a meaningful social impact. Following the project's successful execution and a thorough evaluation by Intel's expert panel, students will be conferred with a certification in AI, validating their proficiency and accomplishments in the field`]
			},
			{
				header: 'Hackathon Participation',
				points: ['Students can participate in international hackathons conducted by Dell and get opportunities to get an internship in Dell Technologies']
			}
		]
	},
	// {
	...
	// 	bullets: [
	// 		{
	// 			header: 'Engaging and hands-on 135 hours of teaching learning content by Intel',
	// 			desc: 'An age-appropriate learning journey based on experiential methodologies covering technical skills and social skills, leading to social impact projects'
	// 		},
	// 		{
	// 			header: 'Covering three AI Domains',
	// 			desc: 'Computer vision, natural language processing and statistical data'
	// 		},
	// 		{
	// 			header: 'Delivery in AI labs',
	// 			desc: 'Powered by Intel technologies with flexible and open infrastructure'
	// 		},
	// 		{
	// 			header: 'Standardized implementation',
	// 			desc: 'Proven approach, with content customization and coach certification through local training partners across the globe'
	// 		},
	// 		{
	// 			header: 'Demonstrated outcomes',
	// 			desc: 'Certificate of Participation for all and Certificate of Accomplishment offered to those youth building and showcasing AI-enabled projects to solve real world problems'
	// 		}
	// 	]
	// },
	// {
	...
	// 		{
	// 			header: 'Inclusive',
	// 			desc: 'Engages youth from diverse backgrounds and does not require prior knowledge or technical expertise'
	// 		},
	// 		{
	// 			header: 'Practical and applicable',
	// 			desc: 'Covers a combination of skill sets, toolsets and mindsets, preparing students to apply them to real-world problems'
	// 		},
	// 		{
	// 			header: 'Flexible and modular',
	// 			desc: `The program can be easily adapted to students' existing knowledge and time availability — contains multiple entry and exit points to match country curriculum needs`
	// 		},
	// 		{
	// 			header: 'Experiential, hands-on and fun',
	// 			desc: 'Age-appropriate and purpose-built to engage students with well-researched and experiential content'
	// 		}
	// 	]
	// },
	// {
	...
	// 			desc: 'Programming and coding, data science, computer vision, natural language processing, statistical data and algorithmic and computational thinking'
	// 		},
	// 		{
	// 			header: 'Social skills',
	// 			desc: 'AI ethics and bias reduction, critical thinking, problem-solving, system mapping, AI solutions building, and social and emotional skills'
	// 		}
	// 	]
	// },
	{
